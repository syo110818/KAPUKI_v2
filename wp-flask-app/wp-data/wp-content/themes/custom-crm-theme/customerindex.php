<html>
  ...
  <body>
    <div class="relative flex size-full min-h-screen flex-col group/design-root overflow-x-hidden" style='font-family: "Noto Serif", "Noto Sans", sans-serif; background-color: #f9f6ec;'>
      <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#ece9f1] px-10 py-3 bg-white z-10" style="position:relative; background-color: #fff;">
        <div class="flex items-center gap-4 text-[#131019]">
          <div class="size-4">
          ...
          <h2 class="text-[#131019] text-lg font-bold leading-tight tracking-[-0.015em]">KAPUKI顧客管理システム</h2>
        </div>
      </header>
